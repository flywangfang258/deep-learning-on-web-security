...
def vggnet():
    ...
    # 声明优化算法、损失函数、学习率等
    network = regression(fc3, optimizer='rmsprop', loss='categorical_crossentropy', learning_rate=0.01)

    # Training
    model = tflearn.DNN(network, checkpoint_path='model_vgg',
                        max_checkpoints=10, tensorboard_verbose=2, tensorboard_dir='logs/vgg')
